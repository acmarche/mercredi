Feature: Test de la gestion des accueils
  ...
  Scenario: J' ajoute un accueil pour un enfant qui n'a pas de fiche santé
    When I follow "Ajouter un accueil"
  ...
  Scenario: J' ajoute un accueil pour un enfant qui a un fiche santé
    ...
    Then I should see "La accueil a bien été ajoutée"
  ...
  Scenario: Je ne peux pas supprimer un accueil passée
    ...
    Then I should see "Détail de la accueil de SIMPSON Bart du mercredi 6 mai 2020"
    Then I press "Supprimer la accueil"
    Then I should see "Une accueil passée ne peut être supprimée"
