Feature: Gestion des présences
  ...
  Scenario: Ajout une présence avec tuteur
    ...
    And I select "Mercredi 2 septembre 2020" from "presence_new_jours"
  ...
  Scenario: Ajout une présence 2 tuteurs
    ...
    When I select "Mercredi 2 septembre 2020" from "presence_new_jours"
    When I additionally select "Mercredi 14 octobre 2020" from "presence_new_jours"
    And I press "Sauvegarder"
    Then I should see "La présence a bien été ajoutée"
    Then I should see "Mercredi 2 septembre 2020"
    Then I should see "Mercredi 14 octobre 2020"
