...
final class SanteFicheController extends AbstractController
{
    ...
    /**
     * @Route("/{uuid}", name="mercredi_animateur_sante_fiche_show", methods={"GET"})
    ...
    public function show(Enfant $enfant): Response
    {
        ...
        if (!$santeFiche->getId()) {
            ...
            return $this->redirectToRoute('mercredi_animateur_enfant_show', ['uuid' => $enfant->getUuid()]);
        }
        ...
        return $this->render(
            '@AcMarcheMercrediAnimateur/sante_fiche/show.html.twig',
            [
                'enfant' => $enfant,
