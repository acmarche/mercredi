...
final class PresenceController extends AbstractController
{
     ...
     * @var string
     */
    private const MERCREDI_PARENT_ENFANT_SHOW = 'mercredi_ecole_enfant_show';
    ...
    /**
     * Route("/", name="mercredi_ecole_presence_index", methods={"GET","POST"}).
     */
    public function index(Request $request): Response
    {
        ...
        return $this->render(
            '@AcMarcheMercrediEcole/presence/index.html.twig',
            [
                'data' => $data,
